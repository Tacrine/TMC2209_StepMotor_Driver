...
```
![alt text](readme/Hal/declare.png)
...
```
![alt text](readme/Hal/init.png)

#### 3. 控制
```c
Motor_Forward_Angle(&Step_Motor_X, 32.1, 64, 'T', 1000);
```
![alt text](readme/Hal/control.png)
...
```
![alt text](readme/TI/ti_msp_dl_config.png)
...
```
##### 然后正常声明电机结构体即可:
![alt text](readme/TI/declare.png)